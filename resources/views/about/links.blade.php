                    ...
                    <a class="text-center" href="https://www.instagram.com/aidora.fashion/">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="text-center" href="https://www.instagram.com/aidora.fashion/"><p><b>Shopee</b></p></a>
                            </div><!--card-body-->
                        </div><!--card-->
                    </a>
                </div><!--col-->
                    ...
                    <a class="text-center" href="https://www.instagram.com/aidora.fashion/">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="text-center" href="https://www.instagram.com/aidora.fashion/"><p><b>Facebook Page</b></p></a>
                            </div><!--card-body-->
                        </div><!--card-->
                    </a>
                </div><!--col-->
